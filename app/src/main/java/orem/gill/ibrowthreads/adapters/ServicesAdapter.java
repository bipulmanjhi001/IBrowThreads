...
import orem.gill.ibrowthreads.activities.ServiceDetailActivity;
...
public class ServicesAdapter extends RecyclerView.Adapter<ServicesAdapter.ChatHolder> {

    private Context mContext;
    private ArrayList<ServicesPOJO> list;

    public ServicesAdapter(Context mContext, ArrayList<ServicesPOJO> list) {
    ...
    public ChatHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new TinyDB(mContext).putString(GeneralValues.SELECTED_SERVICE,new Gson().toJson(list.get(holder.getAdapterPosition())));
                ((Activity)mContext).startActivity(new Intent(mContext, ServiceDetailActivity.class));
            }
        });
    ...
    public void onBindViewHolder(final ChatHolder holder, final int position) {
        ServicesPOJO item=list.get(position);
